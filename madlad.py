...
# # Load the pipeline and specify the device (0 for the first GPU)
# classifier = pipeline("sentiment-analysis", device=0)

# # Perform inference
# result = classifier("I love using the new GPU for computations!")
# print(result)
...
translator = pipeline('translation', model=model, tokenizer=tokenizer, src_lang="eng_Latn", tgt_lang='npi_Deva', max_length = 1000000, device=0)
